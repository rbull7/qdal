...
Open Research is a movement that stresses the importance of more honest and transparent research by promoting a series of research principles and by warning from common, although not necessarily intentional, questionable practices and misconceptions.
...
Finally, with new data and a different analysis the results are **generalisable** if you obtain the same results as the original study.
...
Registered Reports work for a variety of research types, from quantitative to qualitative, from exploratory to corroboratory.
...
Versioning systems are primarily thought to be for programming work (developing software) but they have been increasingly adopted in (knowledge-oriented, non-applied) research given that a lot of the research process is based on computational aspects (managing data, analysing data with code, writing manuscripts, etc).
...
One of the advantages of using a version control system is that it helps ensure computational reproducibility.
